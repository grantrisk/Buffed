...
from forms import AccountSetupForm, ProfileQuestionnaire, DietQuestionnaire

register_page = Blueprint("register", __name__, static_folder="static", template_folder="templates")


# TODO: replace with code for setup_questions here or..?
...
# TODO: need to get info and print it/confirm submission works
# TODO: need to disable navbar use in setup screen
